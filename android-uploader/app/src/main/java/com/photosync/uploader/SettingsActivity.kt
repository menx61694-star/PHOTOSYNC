...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(settingButton("Home") {
            startActivity(Intent(this, MainActivity::class.java))
            finish()
        })
        root.addView(settingButton("Theme colour") { chooseTheme() })
        root.addView(settingButton("Auto discovery: ON") {
            prefs.edit().putBoolean("auto_discovery", !prefs.getBoolean("auto_discovery", true)).apply()
            Toast.makeText(this, if (prefs.getBoolean("auto_discovery", true)) "Auto discovery enabled" else "Auto discovery disabled", Toast.LENGTH_SHORT).show()
            recreate()
        })
        root.addView(settingButton("Clear saved server") {
        ...
        root.addView(settingButton("About PhotoSync") {
    ...
    private fun chooseTheme() {
        ...
        androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setItems(colours) { _, which ->
                ...
                Toast.makeText(this, "Theme colour saved. Reopen PhotoSync to apply.", Toast.LENGTH_SHORT).show()
            }
            .show()
    }
